...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1048);
...
var _react = _interopRequireDefault(__webpack_require__(1048));
...
var React = _interopRequireWildcard(__webpack_require__(1048));
...
var _react = __webpack_require__(1048);
...
// EXTERNAL MODULE: external "C:\\Users\\eoeoa\\Desktop\\github\\daedaem_blog\\node_modules\\react\\index.js"
var external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_ = __webpack_require__(1048);
var external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default = /*#__PURE__*/__webpack_require__.n(external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_);
;// CONCATENATED MODULE: ./node_modules/gatsby-script/dist/partytown-context.js

const PartytownContext = /*#__PURE__*/(0,external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_.createContext)({});
...
function Script(props) {
  ...
  const {
    collectScript
  } = (0,external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_.useContext)(PartytownContext);
  (0,external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_.useEffect)(() => {
    let details;
  ...
  if (strategy === ScriptStrategy.offMainThread) {
    ...
    if (inlineScript) {
      return /*#__PURE__*/external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().createElement("script", extends_default()({
        type: "text/partytown",
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-react-helmet',plugin:__webpack_require__(1674),options:{"plugins":[]}},{name:'gatsby-plugin-image',plugin:__webpack_require__(2588),options:{"plugins":[]}},{name:'gatsby-plugin-canonical-urls',plugin:__webpack_require__(9601),options:{"plugins":[],"siteUrl":"https://daedaem.netlify.app/","stripQueryString":true}},{name:'gatsby-plugin-sitemap',plugin:__webpack_require__(4988),options:{"plugins":[],"output":"/sitemap","createLinkInHead":true,"entryLimit":45000,"query":"{ site { siteMetadata { siteUrl } } allSitePage { nodes { path } } }","excludes":[]}},{name:'partytown',plugin:__webpack_require__(5292),options:{"plugins":[]}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
const prefetchPathname=loader.enqueue;const StaticQueryContext=/*#__PURE__*/external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().createContext({});function StaticQueryDataRenderer({staticQueryData,data,query,render}){const finalData=data?data.data:staticQueryData[query]&&staticQueryData[query].data;return (0,emotion_react_esm/* jsx */.tZ)((external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default()).Fragment,null,finalData&&render(finalData),!finalData&&(0,emotion_react_esm/* jsx */.tZ)("div",null,"Loading (StaticQuery)"));}const StaticQuery=props=>{const{data,query,render,children}=props;return (0,emotion_react_esm/* jsx */.tZ)(StaticQueryContext.Consumer,null,staticQueryData=>(0,emotion_react_esm/* jsx */.tZ)(StaticQueryDataRenderer,{data:data,query:query,render:render||children,staticQueryData:staticQueryData}));};const useStaticQuery=query=>{var _context$query;if(typeof (external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default()).useContext!==`function`&&"production"===`development`){}const context=external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().useContext(StaticQueryContext);// query is a stringified number like `3303882` when wrapped with graphql, If a user forgets
...
"use strict";
var React=_interopRequireWildcard(__webpack_require__(1048));var _gatsby=__webpack_require__(7533);var _path=__webpack_require__(1423);function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: Remove for v3 - Fix janky path/asset prefixing
...
var createNamedContext = function createNamedContext(name, defaultValue) {
  var Ctx = (0,external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_.createContext)(defaultValue);
...
var Location = function Location(_ref) {
  ...
  return external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().createElement(
    LocationContext.Consumer,
    null,
    function (context) {
      return context ? children(context) : external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().createElement(
        LocationProvider,
        null,
        children
      );
...
}((external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default()).Component);
    ...
    function (baseContext) {
      return external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().createElement(
        ...
        function (locationContext) {
          return external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().createElement(RouterImpl, es_extends({}, baseContext, locationContext, props));
        }
      );
    }
  );
...
var RouterImpl = function (_React$PureComponent) {
  ...
  RouterImpl.prototype.render = function render() {
    ...
    var routes = external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().Children.toArray(children).reduce(function (array, child) {
    ...
    if (match) {
      ...
      var clone = external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().cloneElement(element, props, element.props.children ? external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().createElement(
        Router,
      ...
      return external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().createElement(
        ...
        external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().createElement(
          FocusWrapper,
          wrapperProps,
          clone
        )
  ...
  return RouterImpl;
}((external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default()).PureComponent);
...
var FocusHandler = function FocusHandler(_ref3) {
  ...
  return external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().createElement(
    ...
    function (requestFocus) {
      return external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().createElement(FocusHandlerImpl, es_extends({}, domProps, {
        component: component,
...
////////////////////////////////////////////////////////////////////////////////
var forwardRef = (external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default()).forwardRef;
    ...
    function (_ref5) {
      ...
      return external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().createElement(
        ...
        function (_ref6) {
          ...
          return external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().createElement("a", es_extends({
            ref: ref || innerRef,
  ...
  return external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().createElement(
    ...
    function (_ref7) {
      ...
      return external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().createElement(
        ...
        null,
        function (locationContext) {
          return external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().createElement(RedirectImpl, es_extends({}, locationContext, { baseuri: baseuri }, props));
        }
      );
    }
  );
...
var useLocation = function useLocation() {
  var context = (0,external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_.useContext)(LocationContext);
...
var useNavigate = function useNavigate() {
  var context = (0,external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_.useContext)(BaseContext);
...
var createRoute = function createRoute(basepath) {
  return function (element) {
    ...
    if (element.type === (external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default()).Fragment && element.props.children) {
      return external_C_Users_eoeoa_Desktop_github_daedaem_blog_node_modules_react_index_js_default().Children.map(element.props.children, createRoute(basepath));
    }
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1048);
...
var React = __webpack_require__(1048);
...
"use strict";
module.exports = require("C:\\Users\\eoeoa\\Desktop\\github\\daedaem_blog\\.cache\\ssr-builtin-trackers\\fs");
...
"use strict";
module.exports = require("C:\\Users\\eoeoa\\Desktop\\github\\daedaem_blog\\node_modules\\react-dom\\server.js");
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-01dbe7bc42b93f510ec2.js"],"app":["/app-06d5a553077419d789d2.js"],"component---src-pages-404-tsx":["/component---src-pages-404-tsx-c92143c67c13aa08ea26.js"],"component---src-pages-index-tsx":["/component---src-pages-index-tsx-52564098ad117137b95a.js"],"component---src-pages-info-tsx":["/component---src-pages-info-tsx-fabb2b19faf4b73daf3d.js"],"component---src-templates-post-template-tsx":["/component---src-templates-post-template-tsx-b39805dc8f3f9d3b0e13.js"]}');
...
/* global HAS_REACT_18 */const React=__webpack_require__(1048);const path=__webpack_require__(1423);const{renderToString,renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(3970);const{ServerLocation,Router,isRedirect}=__webpack_require__(3631);const merge=__webpack_require__(9996);const{StaticQueryContext}=__webpack_require__(7533);const fs=__webpack_require__(9401);const{WritableAsPromise}=__webpack_require__(5897);const{RouteAnnouncerProps}=__webpack_require__(236);const{apiRunner,apiRunnerAsync}=__webpack_require__(4067);const asyncRequires=__webpack_require__(5418);const{version:gatsbyVersion}=__webpack_require__(1741);const{grabMatchParams}=__webpack_require__(9755);const chunkMapping=__webpack_require__(9804);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
